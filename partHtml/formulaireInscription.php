<form method="POST" action="./WorkPHP/inscription2.php">
    ...
    <input type="radio" name="genre" value="trans"/> Trans<br>
    <input type="radio" name="genre" value="autre"/> Autre<br>
    <br/>
    <label>
        <input type="radio" name="situation" value="celibataire">Celibataire<br>
        <input type="radio" name="situation" value="couple">Couple<br>
        <input type="radio" name="situation" value="famille" checked>Famille<br>
    </label>
    <br/>
