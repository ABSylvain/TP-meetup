<form method="POST" action="./WorkPHP/Evenement2.php">
    ...
    <br/>
    <input type="text" name="heure" placeholder="19h00"/>
    <br/>
    <input type="text" name="dure" placeholder="4h"/>
    <br/>
    <input type="text" name="ressource" placeholder="Les besoins"/>
    <br/>
    <input type="text" name="capacite" placeholder="Nombre de personne"/>
